...
# 패키지 아이디는 매번 변경된다.
export PACKAGE_ID=order_v1:b8a158706d07e8dd5215c1a0f20e93b8b08e6bb5984c536c16996c4f23fd4a1e
...
export CC_VERSION=v1
# 패키지 아이디는 매번 변경된다.
export PACKAGE_ID=contract_v1:f155fc9510ea85fbd2525405b37907fd7d37a4177bd1abea81ae4185bd0e580b
