...
declare -A keystore_dirs=(
  ["NsmartsMSP"]="../organizations/peerOrganizations/nsmarts.co.kr/admin/msp/keystore"
  ["ViceMSP"]="../organizations/peerOrganizations/vice.com/admin/msp/keystore"
  ["ViceKRMSP"]="../organizations/peerOrganizations/vice-kr.co.kr/admin/msp/keystore"
)
